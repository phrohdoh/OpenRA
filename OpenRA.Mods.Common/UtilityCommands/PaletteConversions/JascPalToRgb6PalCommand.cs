...
{
	public class JascPalToRgb6PalCommand : IUtilityCommand
	{
		string IUtilityCommand.Name => "--jasc-to-rgb6";
		...
		[Desc("in.pal [out.pal OR --to-stdout]", "Converts a JASC palette to a 6bit VGA palette.")]
