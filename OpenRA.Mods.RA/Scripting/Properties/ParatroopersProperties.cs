...
namespace OpenRA.Mods.RA.Scripting
{
	...
	public class ParatroopersProperties : ScriptActorProperties, Requires<ParatroopersPowerInfo>
	{
		...
		public Actor[] SendParatroopers(WPos target, bool randomize = true, int facing = 0, string[] dropItems = null)
		{
			return pp.SendParatroopers(Self, target, randomize, facing, dropItems);
		}
	}
}